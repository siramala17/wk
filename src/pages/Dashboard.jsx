...
function getQuickLinks(t) {
  return [
    ...
    { to: '/chat',              label: t.quick.aiChat,     emoji: '🤖', grad: ['#4f46e5','#7c3aed'], shadow: 'rgba(109,40,217,0.40)'  },
...
export default function Dashboard() {
  ...
  return (
    <>
      ...
      {mainTab === 'home' && (
        <div className="max-w-5xl mx-auto px-4 pt-4 pb-6 animate-fade-in">

          {/* ── Full-width: Announcements + PWA banner ── */}
          {(announcements.some(a => !dismissedIds.has(a.id)) || (installPrompt && !isInstalled)) && (
          ...
          {/* ── 2-column grid on iPad / single column on mobile ── */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">

            {/* Left column: Hero + Weekly Chart */}
            ...
            {/* Right column: Quick Actions + Stats + Daily Tip */}
            <div className="space-y-5">
